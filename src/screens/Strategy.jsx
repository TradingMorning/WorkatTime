          ...
          {isSimulating ? (
            ...
            <div className="bg-[#08080d] border border-white/5 rounded-2xl p-24 text-center border-dashed text-slate-500 font-mono text-xs flex flex-col items-center justify-center space-y-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-[10px] text-slate-600">Select strategy constants and click &ldquo;Execute Telemetry Backtest&rdquo; to generate logs.</p>
              </div>
            </div>
          )}
        </div>
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between border-b border-white/5 pb-3">
                      ...
                      <span className="flex items-center space-x-1 px-2.5 py-1 rounded-full bg-white/[0.03] border border-white/5 text-[9px] font-mono text-slate-400 font-bold shrink-0">
                        {insight.platform === 'Twitter/X' && <FaTwitter className="h-3 w-3 text-[#1da1f2]" />}
                        {insight.platform === 'Reddit' && <MessageSquare className="h-3 w-3 text-[#ff4500]" />}
                        {insight.platform === 'YouTube' && <FaYoutube className="h-3 w-3 text-[#ff0000]" />}
                        {insight.platform === 'Facebook' && <FaFacebook className="h-3 w-3 text-[#1877f2]" />}
                        {insight.platform === 'Instagram' && <FaInstagram className="h-3 w-3 text-[#e1306c]" />}
