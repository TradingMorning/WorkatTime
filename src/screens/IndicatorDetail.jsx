      ...
      try {
        ...
        if (indRes?.success && indRes.data) {
          ...
          const structuredSchema = {
            ...
            "name": fetchedInd.name,
            "applicationCategory": "BusinessApplication",
            "operatingSystem": "Web, MetaTrader, TradingView, cTrader",
            "offers": {
              "@type": "Offer",
              "price": fetchedInd.price && fetchedInd.price.toLowerCase().includes('free') ? "0" : (parseFloat(fetchedInd.price ? fetchedInd.price.replace(/[^0-9.]/g, '') : "0") || "0"),
              "priceCurrency": "USD",
              "availability": "https://schema.org/InStock"
            },
            "aggregateRating": {
              "@type": "AggregateRating",
              "ratingValue": fetchedInd.rating || "4.5",
              "reviewCount": fetchedInd.reviewsCount || "10",
              "bestRating": "5",
              "worstRating": "1"
            },
            "author": {
              "@type": "Organization",
              "name": fetchedInd.author || "FalconSpido Community Author"
            },
            "description": fetchedInd.description
          };
