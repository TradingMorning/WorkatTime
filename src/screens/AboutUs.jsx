    ...
    <div className="max-w-4xl mx-auto px-4 py-16 space-y-12">
      ...
      <div className="bg-[#11111a] border border-white/5 p-8 rounded-xl space-y-4">
        ...
        <p className="text-xs text-slate-400 leading-relaxed">
          In 2026, search engine results are flooded with generic, low-density, or unhelpful AI-generated spam. This &ldquo;thin content&rdquo; makes finding authentic, original Pine Scripts or trading setups highly challenging. 
        </p>
        <p className="text-xs text-slate-400 leading-relaxed">
