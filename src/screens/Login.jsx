...
import { useNavigate, useLocation, Link } from '@/utils/router-compat';
...
export const Login = () => {
  ...
  useEffect(() => {
    dispatch(clearError());
    setSeo({
      title: 'Secure Terminal Login - FalconSpido',
      description: 'Access your verified proprietary indicators, set custom alerts, and administer your backtest settings.',
      path: '/login',
